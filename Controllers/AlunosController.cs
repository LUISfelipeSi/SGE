...
namespace SGE.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Email,Telefone,DataNascimento")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Email,Telefone,DataNascimento")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
